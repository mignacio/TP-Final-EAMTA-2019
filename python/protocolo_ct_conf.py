...
LOG_WIDTH_RAM  = raw_input('Log Ram Width (8/16/32): ')
LOG_RESOLUTION = raw_input('Log NB,NBF (Ex: 8,7): ')
...
portUSB = sys.argv[1]
uart=serial.Serial('COM%s'%int(portUSB),115200)
...
def escuchar():
		...
		log_file.flush()
		hilo_act = threading.currentThread()
